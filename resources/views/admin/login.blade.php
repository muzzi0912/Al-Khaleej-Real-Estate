...
<head>
  ...
  <title>Login - Al Khaleej Real Estate Dubai  </title>
  ...
  <!-- =======================================================
  * Template Name:Al Khaleej Real Estate
  * Template URL: https://gfswebdevelopmentteam.com/nice-admin-bootstrap-admin-html-template/
  * Updated: Apr 20 2024 with Bootstrap v5.3.3
  * Author: gfswebdevelopmentteam.com
  * License: https://gfswebdevelopmentteam.com/license/
  ======================================================== -->
</head>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="{{route('home')}}" class="logo d-flex align-items-center w-auto">
                  <!-- <img src="{{asset('assets/logo.jpg')}} "  width="150px"  height="80px" alt=""> -->
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                              ...
                              <a href="{{route('home')}}" class="logo align-items-center w-auto">
                                    <h2 class="card-title pb-0 fs-4" style="font-weight: bold; color: #333;">Al Khaleej Real Estate</h2>
                                    </a>
                                    <h5 class="card-title pb-0 fs-6">Login to Your Account</h5>
                                    <p class="text-center small" style="color: #666;">Enter your username & password to login</p>
                                </div>
