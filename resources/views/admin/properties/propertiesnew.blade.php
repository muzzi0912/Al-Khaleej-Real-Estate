      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{route('admin_new_properties')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
            ...
            @endif
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="total_beds" name="total_beds" value="{{ old('total_beds') }}" required>
              </div>
              <div class="mb-3">
                <label for="total_washrooms" class="form-label">Total Washrooms</label>
                <input type="number" class="form-control" id="total_washrooms" name="total_washrooms" value="{{ old('total_washrooms') }}" required>
              </div>
              <div class="mb-3">
                <label for="sq_ft" class="form-label">Sq. Ft.</label>
                <input type="number" class="form-control" id="sq_ft" name="sq_ft" value="{{ old('sq_ft') }}" required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="aminities" name="aminities" value="{{ old('aminities') }}" required>
              </div>
              <div class="mb-3">
                <label for="location_map_url" class="form-label">Location Map URL</label>
                <input type="url" class="form-control" id="location_map_url" name="location_map_url" value="{{ old('location_map_url') }}">
              </div>
              <div class="mb-3">
